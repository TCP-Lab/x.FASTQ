...
function _progress_anqfastq {
    ...
    if [[ -n "$latest_log" ]]; then
        ...
        rep_rgx1='^Parsed [0-9]* entries$'
        rep_rgx2='^FIN [0-9]*$'
        rep_rgx3='^DAT [0-9]* reads left$'
        rep_rgx4='^[0-9]* READS PROCESSED$'
        rep_rgx5='^ROUND = [0-9]*, SUM = [0-9.]*, bChange = [0-9.]*, totNum = [0-9]*$'
        rep_rgx="${rep_rgx1}|${rep_rgx2}|${rep_rgx3}|${rep_rgx4}|${rep_rgx5}"
