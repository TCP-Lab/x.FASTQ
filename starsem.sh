...
# ==============================================================================
#  The STAR/RSEM wrapper called by anqFASTQ
# ==============================================================================

# --- Source common settings and functions -------------------------------------
# These variables are exported from the anqFASTQ wrapper:
...
if $paired_reads && $dual_files; then
    ...
    do
        ...
        # Change the working directory (of the SubShell in which this script is
        # running) to DATADIR. I think this is inelegant, but using relative
        # paths is the only workaround I found to successfully feed paths
        # containing spaces to STAR. Even hard-escaping the names of in/out
        # directories by backslashes (i.e., "${r1_infile//" "/'\ '}") didn't
        # work, probably due to some STAR-inherent path handling features.
        cd "$target_dir"
...
_set_motd "${xpath}/config/motd_idle" \
    "smoothly completed" "read alignment"
